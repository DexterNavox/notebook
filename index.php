...
<body>
    <div class="container box" id="tamanho" style="margin-top:30px; ">
        <center>
            <img src="assets/php.png" alt="logo" width="200px" style="margin-bottom:20px;">
            <h4>Controle de Notebook</h4>
        </center>
        <form action="index1" method="post" style="margin-top:20px;">
        ...
        <div style="margin-top:20px;">
            <center>
                <p>Não possuí cadastro? Clique <a href="cadastro_usuario_externo">aqui</a>!</p>
                <!-- <p>Esqueceu a sua senha? Clique <a href="esqueci_senha.php">aqui</a>!</p> -->
            </center>
        </div>
    </div>
