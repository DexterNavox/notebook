...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($resultado->num_rows > 0) {
        ...
        $id_notebook = $array['id_categoria'];
...
<body>
    <div class="container" style="margin-top: 40px" id="container">
        ...
        <form action="_atualizar_status.php" method="post" style="margin-top: 20px">
            <?php
            ...
            ?>
                ...
                <div style="text-align: right;">
                    <a href="listar_status.php" role="button" class="btn btn-primary btn-sm">Voltar a lista</a>
