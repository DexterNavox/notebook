...
<body>
    ...
    <section class="home-section">
        ...
        <div class="container" style="width:659px;">
            ...
            <form action="_inserir_status.php" method="post" style="margin-top: 20px">
                <div class="form-group">
                    <label>Nome do status</label>
                    <input type="text" class="form-control" name="catproduto" placeholder="Insira o status" autocomplete="off">
                </div>
                <br>
