...
<head>
    ...
    <title>GN | Lista de status</title>
    ...
    <section class="home-section">
        ...
        <div class="container">
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    ...
                                    if (($nivel == 1) || ($nivel == 2)) {
                                    ?>
                                        <a href="editar_status-<?php echo $id_categoria ?>" role="button" class="btn btn-warning btn-sm"><i class="far fa-edit"></i>&nbsp; Editar</a>
                                    <?php } ?>
                                    <?php
                                    if (($nivel == 1)) {
                                    ?>
                                        <a href="deletar_status.php?id=<?php echo $id_categoria ?>" role="button" onclick="return confirm('Deseja mesmo excluir esse status?');" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i>&nbsp; Excluir</a>
                                    <?php } ?>
                                </center>
                            </td>
                        <?php } ?>
            ...
            <div style="text-align: right; margin-top:6px;">
                ...
                if (($nivel == 1) || ($nivel == 2)) {
                ?>
                    <a href="adicionar_status.php" role="button" class="btn btn-success btn-sm">Cadastrar status</a>
                <?php } ?>
            </div>
        </div>
